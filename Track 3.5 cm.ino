...
float Kp = 35, Ki = 0.0000015, Kd = 18;
...
void ZTurnNormal() {
  ...
  if (!Inversed)
  {
    ...
    if (sensor[6] > 500 /*when sensor closer to ground500*/) sensor[6] = 1;
    else sensor[6] = 0;
    sensor[7] = analogRead(A7);
    if (sensor[7] > 500 /*when sensor closer to ground500*/) sensor[7] = 1;
    else sensor[7] = 0;
    sensor[8] = analogRead(A8);
    if (sensor[8] > 500 /*when sensor closer to ground500*/) sensor[8] = 1;
    else sensor[8] = 0;
    sensor[9] = analogRead(A9);
    if (sensor[9] > 500 /*when sensor closer to ground500*/) sensor[9] = 1;
    else sensor[9] = 0;
  }
  else
  {
    ...
    sensor[6] = analogRead(A6);
    if (sensor[6] > 500 /*when sensor closer to ground500*/) sensor[6] = 0;
    else sensor[6] = 1;
    sensor[7] = analogRead(A7);
    if (sensor[7] > 500 /*when sensor closer to ground500*/) sensor[7] = 0;
    else sensor[7] = 1;
    sensor[8] = analogRead(A8);
    if (sensor[8] > 500 /*when sensor closer to ground500*/) sensor[8] = 0;
    else sensor[8] = 1;
    sensor[9] = analogRead(A9);
    if (sensor[9] > 500 /*when sensor closer to ground500*/) sensor[9] = 0;
    else sensor[9] = 1;
  }
...
//  delay(500);
  ...
  if ((sensor[0] == 1) && (sensor[1] == 1) && (sensor[2] == 1) && (sensor[3] == 1) && (sensor[4] == 1) && (sensor[5] == 1) && (sensor[6] == 1) && (sensor[7] == 1) && (sensor[8] == 1) && (sensor[9] == 0)) //1111111110
    error = 9;
  else if ((sensor[0] == 1) && (sensor[1] == 1) && (sensor[2] == 1) && (sensor[3] == 1) && (sensor[4] == 1) && (sensor[5] == 1) && (sensor[6] == 1) && (sensor[7] == 1) && (sensor[8] == 0) && (sensor[9] == 0)) //1111111100
    error = 8;
  else if ((sensor[0] == 1) && (sensor[1] == 1) && (sensor[2] == 1) && (sensor[3] == 1) && (sensor[4] == 1) && (sensor[5] == 1) && (sensor[6] == 1) && (sensor[7] == 0) && (sensor[8] == 0) && (sensor[9] == 0)) //1111111000
    error = 7;
  else if ((sensor[0] == 1) && (sensor[1] == 1) && (sensor[2] == 1) && (sensor[3] == 1) && (sensor[4] == 1) && (sensor[5] == 1) && (sensor[6] == 0) && (sensor[7] == 0) && (sensor[8] == 0) && (sensor[9] == 0)) //1111110000
    error = 6;
  else if ((sensor[0] == 1) && (sensor[1] == 1) && (sensor[2] == 1) && (sensor[3] == 1) && (sensor[4] == 1) && ((sensor[5] == 0) || ((sensor[6] == 0) && (sensor[7] == 0)) || (sensor[8] == 0)) && (sensor[9] == 1)) //1111100001 or 1111100011 or 1111110001
    error = 4;
  else if ((sensor[0] == 1) && (sensor[1] == 1) && (sensor[2] == 1) && (sensor[3] == 1) && (sensor[4] == 0) && ((sensor[5] == 0) && (sensor[6] == 0) && (sensor[7] == 0)) && (sensor[8] == 1) && (sensor[9] == 1)) //1111000011
    error = 3;
  else if ((sensor[0] == 1) && (sensor[1] == 1) && (sensor[2] == 1) && ((sensor[3] == 0) || ((sensor[4] == 0) && (sensor[5] == 0)) || (sensor[6] == 0)) && (sensor[7] == 1) && (sensor[8] == 1) && (sensor[9] == 1)) //1110000111 or 1110001111 or 1111000111
    error = 0;
  else if ((sensor[0] == 1) && (sensor[1] == 1) && (sensor[2] == 0) && (sensor[3] == 0) && (sensor[4] == 0) && ((sensor[5] == 0) && (sensor[6] == 1) && (sensor[7] == 1)) && (sensor[8] == 1) && (sensor[9] == 1)) //1100001111
    error = -3;
  else if ((sensor[0] == 1) && ((sensor[1] == 1) || ((sensor[2] == 1) && (sensor[3] == 1)) || (sensor[4] == 1)) && (sensor[5] == 0) && (sensor[6] == 0) && (sensor[7] == 0) && (sensor[8] == 0) && (sensor[9] == 1)) //1000011111 or 1000111111 or 1100011111
    error = -4;
  else if ((sensor[0] == 0) && (sensor[1] == 0) && (sensor[2] == 0) && (sensor[3] == 0) && (sensor[4] == 1) && (sensor[5] == 1) && (sensor[6] == 1) && (sensor[7] == 1) && (sensor[8] == 1) && (sensor[9] == 1)) //0000111111
    error = -6;
  else if ((sensor[0] == 0) && (sensor[1] == 0) && (sensor[2] == 0) && (sensor[3] == 1) && (sensor[4] == 1) && (sensor[5] == 1) && (sensor[6] == 1) && (sensor[7] == 1) && (sensor[8] == 1) && (sensor[9] == 1)) //0001111111
    error = -7;
  else if ((sensor[0] == 0) && (sensor[1] == 0) && (sensor[2] == 1) && (sensor[3] == 1) && (sensor[4] == 1) && (sensor[5] == 1) && (sensor[6] == 1) && (sensor[7] == 1) && (sensor[8] == 1) && (sensor[9] == 1)) //0011111111
    error = -8;
  else if ((sensor[0] == 0) && (sensor[1] == 1) && (sensor[2] == 1) && (sensor[3] == 1) && (sensor[4] == 1) && (sensor[5] == 1) && (sensor[6] == 1) && (sensor[7] == 1) && (sensor[8] == 1) && (sensor[9] == 1)) //0111111111
    error = -9;
//  else if ((sensor[0] == 1) && (sensor[1] == 1) && ((sensor[2] == 0) || (sensor[3] == 0)) && (sensor[4] == 1) && (sensor[5] == 0)) //111010 or 110010
//  {
//    ZTurnTransition();
//  }
  else if ((sensor[0] == 1) && (sensor[1] == 1) && (sensor[2] == 1) && (sensor[3] == 1) && (sensor[4] == 1) && (sensor[5] == 1) && (sensor[6] == 1) && (sensor[7] == 1) && (sensor[8] == 1) && (sensor[9] == 1)) //1111111111
  {
    if ((error >= -9 && error < 0)) error = -10;    else if (error <= 9 && error > 0) error = 10;
    else if (error == 0) deadEndMechanics();
  }
  if((sensor[0] == 0) && (sensor[1] == 0) && (sensor[2] == 0) && ((sensor[3] == 1) || ((sensor[4] == 1) && (sensor[5] == 1)) || (sensor[6] == 1)) && (sensor[7] == 0) && (sensor[8] == 0) && (sensor[9] == 0)) //0001111000 0000111000 0001110000
    Inversed=!Inversed;
...
void deadEndMechanics() {
  ...
  Serial.print(" ");
  Serial.println(sensor[9]);
  if ((sensor[0] == 1) && (sensor[1] == 1) && (sensor[2] == 1) && (sensor[3] == 1) && (sensor[4] == 1) && (sensor[5] == 1) && (sensor[6] == 1) && (sensor[7] == 1) && (sensor[8] == 1) && (sensor[9] == 1)) //1111111111
  {
...
void read_junction()
{
  ...
  if ((sensor[0] == 1) && (sensor[1] == 1) && (sensor[2] == 1) && (sensor[3] == 1) && ((sensor[4] == 0) || (sensor[5] == 0)) && (sensor[6] == 0) && (sensor[7] == 0) && (sensor[8] == 0) && (sensor[9] == 0)) //111000
  {
    error = 5;//new condition
    delayed = true;
    PID_value = 90;
    ...
    if ((sensor[0] == 0) && (sensor[1] == 0) && (sensor[2] == 1) && (sensor[3] == 1) && (sensor[4] == 1) && (sensor[5] == 1) && (sensor[6] == 1) && (sensor[7] == 1) && (sensor[8] == 0) && (sensor[9] == 0))
    {
      Inversed = !Inversed;
      error = -9;
    }
 ...
 // }
  ...
  else if ((sensor[0] == 0) && (sensor[1] == 0) && (sensor[2] == 0) && (sensor[3] == 0) && (sensor[4] == 0) && (sensor[5] == 0) && (sensor[6] == 0) && (sensor[7] ==0) && (sensor[8] == 0) && (sensor[9] == 0)) //000000
  {
  ...
  else if ((sensor[0] == 1) && (sensor[1] == 1) && (sensor[2] == 0) && (sensor[3] == 0) && ((sensor[4] == 0) || (sensor[5] == 0)) && (sensor[6] == 0) && (sensor[7] == 0) && (sensor[8] == 0) && (sensor[9] == 0)) //100000
  {
    Serial.println("JUnction 110000");
    error = 5;//new condition
    delayed = true;
